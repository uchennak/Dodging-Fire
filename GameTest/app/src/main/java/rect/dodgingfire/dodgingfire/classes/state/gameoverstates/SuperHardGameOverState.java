 ...
 */
public class SuperHardGameOverState extends State {

    private String playerScore;
    private String gameOverMessage = "GAME OVER";

    public SuperHardGameOverState(int playerScore) {
        this.playerScore = playerScore + ""; // Convert int to String
        if (playerScore > GameMainActivity.getSuperHardHighScore()) {
            GameMainActivity.setSuperHardHighScore(playerScore);
