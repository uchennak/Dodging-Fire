 ...
 */
public class SuperDuperHardGameOverState extends State {

    private String playerScore;
    private String gameOverMessage = "GAME OVER";

    public SuperDuperHardGameOverState(int playerScore) {
        this.playerScore = playerScore + ""; // Convert int to String
        if (playerScore > GameMainActivity.getSuperDuperHardHighScore()) {
            GameMainActivity.setSuperDuperHardHighScore(playerScore);
