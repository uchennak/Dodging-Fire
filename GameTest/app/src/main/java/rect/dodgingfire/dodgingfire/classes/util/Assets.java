...
public class Assets {
    ...
    public static Bitmap dodgingFireWelcome, block, cloud1, cloud2, duck, grass, jump, swipeUp, keepOnSwiping,
            run1, run2, run3, run4, run5, scoreDown, score, startDown, start,
            icLauncher, iceCream1, iceCream2, iceCream3, fire, mountains, easyB, hardB,
            superHardB, easyBDown, hardBDown, superHardBDown ;
   ...
   // public static Animation runAnim, aba;
    ...
    public static void load() {
        ...
        dodgingFireWelcome = loadBitmap("dodgingfire_welcome.png", true);

        easyB = loadBitmap("easy-button.png",true);
        hardB = loadBitmap("hard-button.png", true);
        superHardB = loadBitmap("super-hard-button.png", true);

        easyBDown = loadBitmap("easy-button-down.png",true);
        hardBDown = loadBitmap("hard-button-down.png", true);
        superHardBDown = loadBitmap("super-hard-button-down.png", true);
        ...
        swipeUp = loadBitmap("swipeUp.png",true);
        keepOnSwiping = loadBitmap("keep-on-swiping-up.png", true);
